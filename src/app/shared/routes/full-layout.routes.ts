...
export const Full_ROUTES: Routes = [
  ...
  {
    path: 'driver-loads',
    loadChildren: () => import('../../driver-loads/driver-loads.module').then(m => m.DriverLoadsModule)
  },
  {
    path: 'my-carriers',
    loadChildren: () => import('../../my-carriers/my-carriers.module').then(m => m.MyCarriersModule)
  },
  {
    path: 'calendar',
